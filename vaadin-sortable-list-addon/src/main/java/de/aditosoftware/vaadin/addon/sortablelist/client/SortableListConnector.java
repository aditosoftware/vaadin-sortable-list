...
import de.aditosoftware.vaadin.addon.sortablelist.client.bindings.*;
...
public class SortableListConnector extends AbstractLayoutConnector {
  ...
  public void onStateChanged(StateChangeEvent stateChangeEvent) {
    ...
    SortableInstance sortable =
        SortableBindings.createSortable(getWidget().getElement(), getState());

    // Create a listener for when the user stop sorting.
    SortableBindings.addSortableStopListener(
        sortable,
        pO -> {
